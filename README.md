...
3. Default to Cloudflare DNS 1.1.1.1. You can change to other supported DNS over TLS providers by modifying /opt/var/stubby/stubby.yml.
...
* Thank you to snbforum members @skeal and @M@arco who volunteered their time performing testing and providing feedback.
